/**
 * Root ESLint configuration for the GoodVibes Codex monorepo.
 *
 * Lints authored code under packages/* plus plugin hooks and scripts. Flat
 * config, ESLint 9+.
 */
...
export default [
  ...
  /**
   * TypeScript source in the workspace packages
   */
  {
