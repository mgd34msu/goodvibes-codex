/**
 * SQLite query executor: parameterized SELECT and write paths through the pool.
 *
 * This is the tested `db_query` path, because sql.js is connect's own bundled
 * dependency rather than a lazily loaded remote driver.
 */
